...
class TransactionReceiptCard extends StatelessWidget {
  ...
  const TransactionReceiptCard({Key? key, required this.transaction})
    : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          ReceiptInformationTile(
            label: 'Total Fee',
            value: '${transaction.currency} ${transaction.fees}',
          ),
          ReceiptInformationTile(
            label: 'Prev. Balance',
            value: '${transaction.currency} ${transaction.previousBalance}',
          ),
          ReceiptInformationTile(
            label: 'New Balance',
            value: '${transaction.currency} ${transaction.currentBalance}',
          ),
          ReceiptInformationTile(
            label: 'Completed By',
