                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        ReceiptDetailTile(
                          icon: Boxicons.bx_layer,
                          label: 'Cards Submitted',
                          value: '${data.cardsSubmitted}',
                        ),
                        _buildDivider(isDark),
                        ...
                        ReceiptDetailTile(
                          ...
                          value: '\$${data.totalFaceValue.toStringAsFixed(2)}',
                        ),
                        _buildDivider(isDark),
                        ...
                        ReceiptDetailTile(
                          ...
                          label: 'Sell Rate',
                          value: '${data.sellRate.toStringAsFixed(2)}%',
                          isHighlighted: true,
                          isGreen: true,
                        ),
                        _buildDivider(isDark),
