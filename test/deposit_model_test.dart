...
void main() {
  group('Deposit parsing robustness', () {
    test(
      'accepts int, double, num, string, and null amounts in bank transfer details',
      () {
    ...
    test(
      'parses deposit payloads with bank transfer details and stringified numeric fields',
      () {
